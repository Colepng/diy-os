...
impl From<ScanCode> for Keycode {
    fn from(value: ScanCode) -> Self {
        ...
        match value.scan_code {
            ...
            0x0D => Self::Tab,
            0x0E => Self::Grave,
            0x11 => Self::LeftAlt, // left alt
            0x12 => Self::LeftShift,
            0x14 => Self::LeftCtrl, // left ctrl
            0x15 => Self::Q,
            0x16 => Self::One,
            0x1A => Self::Z,
            0x1B => Self::S,
            ...
            0x4D => Self::P,
            0x4E => Self::Hyphen,
            0x54 => Self::LeftSquareBracket,
            0x55 => Self::Equal,
            0x58 => Self::Capslock,
            0x59 => Self::RightShift,
            0x5A => Self::Enter,
            0x5B => Self::RightSquareBracket,
            0x5D => Self::Backslash,
            0x66 => Self::Backspace,
            0x69 => Self::Keypad1,
            0x6B => Self::Keypad4,
            0x6C => Self::Keypad7,
            0x70 => Self::Keypad0,
            0x71 => Self::KeypadPeriod,
            0x72 => Self::Keypad2,
            0x73 => Self::Keypad5,
            0x74 => Self::Keypad6,
            0x75 => Self::Keypad8,
            0x76 => Self::Escape,
            0x77 => Self::KeypadNumlock,
            0x78 => Self::F11,
            0x79 => Self::KeypadAdditon,
            0x7A => Self::Keypad3,
            0x7B => Self::KeypadMinus,
            0x7C => Self::KeypadAstrisk,
            0x7D => Self::Keypad9,
            0x7E => Self::ScrollLock,
            0x83 => Self::F7,
            _ => Self::F24, // hacky fix in the mean time,
        }
    }
}
